    ...
    public void run(Connection connection, ClassManagement classManagement){
        ...
        while (true) {
            ...
            if(userInput[0].equals("new-class")){
                ...
                showHelp();
            else if (classManagement.activeClass != null) {
                if (userInput[0].equals("show-class")){
                    if(userInput.length !=1){
                    ...
                    if(userInput.length == 4)
                        StudentManagement.addStudent(userInput[1],Integer.parseInt(userInput[2]), userInput[3],connection,classManagement.activeClass);
                    ...
                    GradesManagement.gradeBook(classManagement.activeClass, connection);
                }
                else{
                ...
                LOGGERS.severe("Please select current class");
        }
    }
